export async function verifyToken(cookie: string): Promise<Response> {
  return await fetch(
    process.env.NEXT_PUBLIC_BACKEND_HOST0 + '/auth/verifytoken',
    {
      method: 'GET',
      headers: {
        Cookie: cookie,
...
export async function verifySession(cookie: string): Promise<Response> {
  return await fetch(
    process.env.NEXT_PUBLIC_BACKEND_HOST0 + '/auth/verifysession',
    {
      method: 'GET',
      headers: {
        Cookie: cookie,
...
export async function verify2FAToken(cookie: string): Promise<Response> {
  return await fetch(
    process.env.NEXT_PUBLIC_BACKEND_HOST0 + '/auth/token2FA',
    {
      method: 'GET',
      headers: {
        Cookie: cookie,
