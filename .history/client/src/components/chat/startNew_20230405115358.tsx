...
function StartNew() {
    return (
        <div className="flex flex-col w-[100%] h-[95%] ">
            ...
            <div className="flex flex h-full w-full flex-col lg:flex-row border">
              <div className="sm:flex sm:items-center lg:flex m-auto mb-0 flex-col self-center h-[85%] w-[50%] ">
                ...
                <button
                  ...
                  className="border-white peer block appearance-none mt-20
                    rounded-full border-2 bg-transparent py-2.5 px-3 text-xs sm:text-s w-[100px]
              ...
              <div className="flex m-auto mb-0 flex-row self-center h-[85%] w-[50%]">
                <div className="flex flex-col h-[10%] w-[90%]">
                  ...
                  <div className="sm:flex sm:flex-col relative flex items-center justify-center border">
                  <input type="text" name="nickname" id="nickname"
                    ...
                    <button
                      ...
                      className="lg:right-0 lg:top-0 lg:absolute border-white peer block appearance-none 
                            rounded-full border-2 bg-transparent py-2.5 px-3 text-xs sm:text-sm w-[30%] sm:w-[100px]
