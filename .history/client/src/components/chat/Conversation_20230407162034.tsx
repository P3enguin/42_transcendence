...
function Conversation ({nickname, avatar}: any) {
    return(
      <div className="flex w-full h-full justify-between flex-col ">
        <div className="flex h-[8%] w-full items-center border-b justify-between p-2 m-auto">
              ...
              <div className="sm:flex flex-col relative  w-[90%] mb-2 items-center">
                  <input type="text" name="nickname" id="nickname"
                    ...
                    <button  type="submit"
                      ...
                      rounded-full bg-transparent py-2.5  px-12 text-xs sm:text-sm w-[50%] sm:w-[100px]
