        ...
        <div className="flex flex-row items-center justify-between w-full px-3 py-2">
          ...
          <div className="flex flex-col w-[100%] h-[95%] border-t m-auto
            items-center justify-end ">
              <div className="sm:flex flex-col relative  w-[90%] mb-2 justify-between">
                  <input type="text" name="nickname" id="nickname"
                    ...
                    <button  type="submit"
                      ...
                      rounded-full bg-transparent py-2.5 self-end text-xs sm:text-sm w-[50%] sm:w-[100px]
                      focus:outline-none focus:ring-0 bg-blue-500 sm:m-5 lg:m-0 /">
                            <SendIcon />
                    </button>
              </div>
        </div>
