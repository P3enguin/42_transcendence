  ...
  // setLoading(false);
    return (
      ...
      <Link href={`/users/${player}`}>
        <Image className="h-14 w-14 md:w-16 md:h-16 cursor-pointer rounded-full border" src={process.env.NEXT_PUBLIC_BACKEND_HOST + "/avatars/"} alt="Avatar" width={12} height={12} />
      </Link> 
      </div>
