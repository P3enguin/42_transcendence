            ...
            items-center justify-end ">
              <div className="sm:flex flex-col relative  w-[90%] mb-2 items-center">
                  <input type="text" name="nickname" id="nickname"
                    ...
                    <button  type="submit" 
                      className="self-center right-0 top-0 absolute  peer block appearance-none mt-2
                      rounded-full bg-transparent py-2.5 px-12 text-xs sm:text-sm w-[50%] sx:w-[100px]
