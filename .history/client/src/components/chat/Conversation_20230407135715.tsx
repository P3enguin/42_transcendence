...
function Conversation ({nickname, avatar}: any) {
    return(
      <div className="hidden md:flex w-full justify-between flex-col ">
        <div className="flex h-[10%] w-full items-center border-b justify-between p-2">
          <div className="flex flex-row border w-[20%]">
            <Image
              src={avatar} alt="avatar" width={20} height={20} />
              <h3> :{nickname}</h3>
            </div> 
          <div><SettingIcon /></div>
        </div>
