...
function Chat({ jwt_token, data }: { jwt_token: string; data: any }) {
  ...
  <input type="text" name="nickname" id="nickname"
    class="border-white w-full appearance-none rounded-full border-2 bg-transparent
  ...
  <button type="submit" class="border-white block appearance-none rounded-full border-2 bg-transparent
