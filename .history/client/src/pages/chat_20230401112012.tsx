      ...
      <div className="h-[100%] min-w-[360px] flex-col  max-w-[360px] sm:w-[100%] md:border-r">
        ...
        <div className="hidden md:flex w-[1000px] justify-between flex-col ">
          ...
          <div className="flex flex-col w-[100%] h-[95%] ">
            <div className="items-center lg:flex w-[100%] h-[30%] text-3xl">
            ...
            <div className="flex flex h-full w-full flex-col lg:flex-row">
              <div className="md:flex lg:flex m-auto mb-0 flex-col self-center h-[85%] w-[50%] ">
                ...
                <button
                  ...
                  className="border-white peer block appearance-none mt-20
                    ...
                    w-[150px] text-white focus:border-blue-600 focus:outline-none focus:ring-0 bg-blue-500 lg:mt-60 lg:ml-20"
                >
                  Create
                </button>
              </div>
              ...
              <div className="flex m-auto mb-0 flex-row self-center h-[85%] w-[50%]">
                <div className="flex flex-col h-[10%] w-[90%]">
                  ...
                  <div className="md:flex-col relative flex items-center justify-center">
                  <input type="text" name="nickname" id="nickname"
                    ...
                    <button
                      ...
                      className="absolute right-0 top-0 border-white peer block appearance-none 
                            rounded-full border-2 bg-transparent py-2.5 px-3 text-xs md:text-sm w-[200px]
