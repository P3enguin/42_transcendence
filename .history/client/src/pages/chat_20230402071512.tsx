...
function Chat({ jwt_token, data }: { jwt_token: string; data: any }) {
  ...
  return (
    <>
      ...
      <div className="h-[100%] md:min-w-[360px] flex-col  max-w-[360px] sm:w-[100%] md:border-r">
          ...
          <div className="flex h-[80%] flex-col p-5 pt-0 ">
            ...
            <div className="flex-col overflow-hidden overflow-y-auto space-y-3 mt-1">
              ...
              <div className="flex h-[70px] w-full md:w-[300px] cursor-pointer border 
                  flex-row item-start rounded-2xl text-sm
                   bg-[#8BD9FF] bg-opacity-30 justify-around">
                <img
                  className="h-12 w-12 rounded-full border self-center" 
                  src={pictures.pfp}
                  alt="Avatar"
                />
                <div className="flex flex-col m-3 self-center">
                  <Link href={`/users/${data.player.nickname}`}><h3>{data.player.nickname}</h3></Link>
                  <div className="flex w-[100px] truncate text-green-300">
