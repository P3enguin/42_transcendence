        ...
        <div className="flex-[2_2_0%] justify-between  ">
          ...
          <div className="flex flex-col w-[100%] h-[95%]">
            ...
            <div className="flex flex-row w-[100%] h-[60%] pl-5 ">
              <div className="flex m-auto mb-0 flex-row self-center h-[85%] w-[50%] border">
                <div className="flex flex-col h-[10%] w-[90%]">
                  <h2 className="flex text-xl">Channel : </h2>
                  <input type="text" name="channel" id="password"
              ...
              <button className="mr-5 m-auto w-[200px] rounded-xl bg-[#0097E2] p-1">
              Create </button>
              </div>
              <div className="flex m-auto mb-0 flex-row self-center h-[85%] w-[50%] border">
                <div className="flex flex-col h-[10%] w-[90%]">
                  ...
                  <div className="relative flex intems">
  <input
    type="text"
    name="channel"
    id="password"
    className="border-white peer block w-full appearance-none rounded-full border-2 bg-transparent py-2.5 px-3 text-xs md:text-sm max-w-70 text-white focus:border-blue-600 focus:outline-none focus:ring-0"
    placeholder="channel name"
    required
  />
  <button
    type="submit"
    className="border-white peer block appearance-none rounded-full border-2 bg-transparent py-2.5 px-3 text-xs md:text-sm max-w-70 text-white focus:border-blue-600 focus:outline-none focus:ring-0 bg-blue-500"
  >
    start
  </button>
</div>
