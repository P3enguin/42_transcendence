          ...
          <div className="flex flex-col w-[100%] h-[95%]">
            ...
            <div className="flex flex-row w-[100%] h-[85%] pl-5">
              <div className="flex m-auto mb-0 flex-row self-center h-[85%] w-[50%]   ">
                ...
                className=" border-white green-500 border-red-600 border-gray-300 
              ...
              <div className="flex flex-row h-[85%] w-[50%] m-auto mb-0 ">
                ...
                <input type="text" name="channel" id="password"
                className="peer block w-full appearance-none rounded-full border-2 bg-transparent
                py-2.5 px-3  text-xs md:text-sm 
                text-black focus:border-blue-600 focus:outline-none focus:ring-0"
                placeholder="channel name" required/>
                </div>
              </div>
            </div>
