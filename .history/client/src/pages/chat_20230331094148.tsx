...
function Chat({ jwt_token, data }: { jwt_token: string; data: any }) {
  ...
  return (
    <>
      ...
      <div className=" flex min-h-[700px] min-w-[100px] flex-row rounded-2xl border border-neutral-300 sm:m-20 md:h-[80%]">
        <div className="h-[100%] flex-[1_1_0%] flex-col border-r-[2px]">
          ...
          <div className="flex h-[80%] flex-col pl-5">
            <div>Recent Chat</div>
            <div className="flex-col overflow-hidden overflow-y-auto scrollbar-hide border pr-5">

              <div className="flex h-[70px] w-[300px] cursor-pointer 
                  flex-row items-center justify-between rounded-2xl text-sm
                   bg-[#8BD9FF] bg-opacity-30 p-5">
                <img
                ...
                <div className="flex flex-col border">
                  ...
                  <div className="flex w-[150px] truncate">
                    how are you today? wanna hangout ?
                  </div>
                </div>
                  <div className="flex ">10:00AM</div>
              </div>
