...
function Chat({ jwt_token, data }: { jwt_token: string; data: any }) {
  ...
  return (
    <>
      ...
      <div className="flex w-[90%] flex-row rounded-2xl border border-neutral-300 max-w-[1200px] ">
      <div className="md:h-[100%] md:min-w-[360px] flex-col  max-w-[360px] sm:w-[100%] md:border-r">
