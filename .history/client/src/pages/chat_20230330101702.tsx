            ...
            <div className="flex flex-row w-[100%] h-[60%] pl-5 ">
              ...
              <div className="flex m-auto mb-0 flex-col self-center h-[85%] w-[50%] ">
                ...
                <button
                  name="create"
                  disabled
                  className="mt-4 ml-4 border-white peer block appearance-none
                    rounded-full border-2 bg-transparent py-2.5 px-3 text-xs md:text-sm w-[100px] text-white focus:border-blue-600 focus:outline-none focus:ring-0 bg-blue-500"
                >
                  Create
                </button>
              </div>
