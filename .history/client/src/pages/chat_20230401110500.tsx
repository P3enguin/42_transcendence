              ...
              <div className="flex m-auto mb-0 flex-row self-center h-[85%] w-[50%]">
                <div className="flex flex-col h-[10%] w-[90%]">
                  ...
                  <input type="text" name="nickname" id="nickname"
                    ...
                    <button
                      type="submit"
                      className="lg:right-0 top-0 absolute  border-white peer block appearance-none 
                      ...
                      className="border-white block appearance-none rounded-full border-2 bg-transparent
