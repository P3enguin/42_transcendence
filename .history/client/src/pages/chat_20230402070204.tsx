    ...
    <>
      ...
      <div className="h-[100%] md:min-w-[360px] flex-col  max-w-[360px] sm:w-[100%] md:border-r">
          ...
          <div className="flex h-[15%] w-[100%] flex-col pl-5 ">
            <div>Online Now</div>
            <div className="scroll-hide flex w-[90%] space-x-2 flex-row overflow-hidden overflow-x-auto scrollbar-hide ">
              {
          ...
          <div className="flex h-[80%] flex-col p-5 pt-0">
            <div>Recent Chat</div>
            <div className="flex-col overflow-hidden overflow-y-auto space-y-5 ">
