      ...
      <div className="h-[100%] w-[100%] md:w-[360px] flex-col  md:border-r">
          ...
          <div className="flex h-[80%] flex-col p-5 pt-0 ">
            ...
            <div className="flex-col overflow-hidden overflow-y-auto space-y-3 mt-1 ">
              ...
              <div className="flex space-x-12 sx:space-x-2 md:space-x-2 h-[70px] w-[100%] md:w-[300px] cursor-pointer border 
        ...
        <div className="hidden md:flex w-full justify-between flex-col ">
          ...
          <div className="flex flex-col w-[100%] h-[95%] ">
            <div className="md:items-center md:m-auto lg:flex w-[100%] h-[30%] text-3xl">
