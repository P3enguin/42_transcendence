            ...
            <div className="flex flex-row w-[100%] h-[60%] pl-5 ">
              ...
              <div className="flex m-auto mb-0 flex-row self-center h-[85%] w-[50%] border">
                <div className="flex flex-col h-[10%] w-[90%]">
                  ...
                  text-white focus:border-blue-600 focus:outline-none focus:ring-0"
                  placeholder="channel name" required/>
                  <button type='submit'className=' border-white peer block w-full appearance-none rounded-full border-2 bg-transparent border-l-0
                          py-2.5 px-3  text-xs md:text-sm max-w-70
                        text-white focus:border-blue-600 focus:outline-none focus:ring-0'>start</button>
                  </div>
                </div>
              </div>
            </div>
