              ...
              <div className="flex flex-col h-[85%] w-[50%] m-auto">
                <div className="flex flex-col h-[10%] w-[90%]">
                  ...
                  <input
                    ...
                    name="channel"
                    id="channel"
                    className="border-white w-full appearance-none 
                        rounded-full border-2 bg-transparent py-2.5 px-3 text-xs md:text-sm text-white focus:border-blue-600 focus:outline-none focus:ring-0"
