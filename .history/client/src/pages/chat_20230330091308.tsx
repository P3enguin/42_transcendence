          ...
          <div className="flex flex-col w-[100%] h-[95%]">
            ...
            <div className="flex flex-row w-[100%] h-[85%] pl-5">
              <div className="flex m-auto mb-0 flex-row self-center h-[85%] w-[50%]   ">
                <div className="flex flex-col h-[10%] border-rounded">
                  <h2 className="flex text-xl">Channel : </h2>
                  <input type="text" name="channel" id="password"
        className=" border-green-500 border-red-600border-gray-300 peer block w-full appearance-none rounded-full border-2 bg-transparent
