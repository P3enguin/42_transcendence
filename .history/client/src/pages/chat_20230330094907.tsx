                ...
                <div className="flex flex-col h-[10%] w-[90%]">
                  ...
                  <div className="relative flex items-center justify-center">
                    <input
                      ...
                      name="channel"
                      id="password"
                      className="border-white peer block w-full appearance-none rounded-full border-2 bg-transparent py-2.5 px-3 text-xs md:text-sm max-w-70 text-white focus:border-blue-600 focus:outline-none focus:ring-0 pr-12"
                      placeholder="channel name"
                      required
                    />
                    <button
                      type="submit"
                      className="absolute right-0 top-0 border-white peer block appearance-none rounded-full border-2 bg-transparent py-2.5 px-3 text-xs md:text-sm max-w-70 text-white focus:border-blue-600 focus:outline-none focus:ring-0 bg-blue-500"
                    >
                      start
                    </button>
                  </div>
