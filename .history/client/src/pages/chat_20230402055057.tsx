...
function Chat({ jwt_token, data }: { jwt_token: string; data: any }) {
  ...
  return (
    <>
      ...
      <div className="mt-20 flex md:min-h-[600px] lg:max-w-[1200px] max-w-[680px] md:min-w-[100px] flex-row rounded-2xl border border-neutral-300 md:h-[70%]">
                    ...
                    <button
                      ...
                      className="lg:right-0 lg:top-0 lg:absolute border-white peer block appearance-none 
                            rounded-full border-2 bg-transparent py-2.5 px-3 text-xs md:text-sm w-[40%] md:w-[100px]
                             text-white focus:border-blue-600 focus:outline-none focus:ring-0 bg-blue-500 md:m-5 lg"
                    >
                      start
                    </button>
                  </div>
