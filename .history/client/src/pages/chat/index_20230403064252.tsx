      ...
      <div className="h-[100%] w-[100%] md:w-[360px] flex-col  md:border-r">
          ...
          <div className="flex flex-row justify-between border-t pt-1">
            ...
            <div className="flex-col overflow-hidden overflow-y-auto space-y-3 mt-2 ">
              ...
              <div className="flex justify-between p-2 min-w-[] md:p-0 md:justify-around space-x-2 md:space-x-5 h-[70px] w-[100%] md:w-[300px] cursor-pointer border 
                  flex-row item-start rounded-2xl text-sm
                   bg-[#8BD9FF] bg-opacity-30 justify-center lg:space-x-5 ">
                    <div className="flex flex-row  space-x-2">
                      ...
                      <div className="flex text-xs w-[50%] truncate text-green-300">
                        how are you today? wanna hangout ?
                      </div>
                  </div>
                </div>
                <div className="flex flex-col h-full justify-end w-[30%]">
                  <div className="rounded-full bg-[#01FD91] text-center"> +2</div>
