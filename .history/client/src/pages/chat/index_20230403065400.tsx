              ...
              <div className="flex justify-between p-2 md:p-0 md:justify-around
                  ...
                  flex-row item-start rounded-2xl text-sm
                   bg-[#8BD9FF] bg-opacity-30 ">
                    <div className="flex flex-row space-x-2 w-[70%] border">
                      <img
                      ...
                      <div className="flex text-xs w-full overflow-x-hidden border truncate text-green-300">
                        how are you today? wanna hangout ?
                      </div>
                  </div>
                </div>
                <div className="flex flex-col h-full justify-end ">
                  <div className="rounded-full w-[20px] h-[20px] bg-[#01FD91] text-center"> +2</div>
