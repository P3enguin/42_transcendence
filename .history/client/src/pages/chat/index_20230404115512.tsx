      ...
      <div className="h-[100%] w-[100%] md:w-[360px] flex-col  md:border-r">
          ...
          <div className="flex flex-row justify-between border-t pt-1">
            ...
            <div className="flex-col h-full overflow-hidden overflow-y-auto space-y-3 mt-2">
              ...
              <div className="flex justify-between p-2 md:p-0 md:justify-around border
                    space-x-2 md:space-x-5 h-[70px] w-[100%] md:w-[300px] cursor-pointer 
                  flex-row item-start rounded-2xl text-sm
                   bg-[#8BD9FF] bg-opacity-20 ">
                    <div className="w-[72%] md:w-full flex flex-row space-x-2 ">
                      <img
                      ...
                      <div className="flex text-xs text-green-300 ">
                        how are you today? wanna hangout ? h lk jsdl;fjns;dakf j;dflkjasdoifhas;dfk aj;sdfkl
                      </div>
                    </div>
                </div>
