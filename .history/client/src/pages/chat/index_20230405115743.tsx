  ...
  return (
    <>
      ...
      <div className="h-[100%] w-[100%] md:w-[360px] flex-col  md:border-r">
          ...
          <div className="hidden flex h-[15%] w-[100%] flex-col pl-5 pr-5">
              <div >Online Now</div>
            <div className="scroll-hide flex w-[90%] space-x-1 flex-row overflow-hidden overflow-x-auto scrollbar-hide ">
              { showRecentChat &&
                <Link key={0} href={`/users/${data.player.nickname}`}>
                <img className="h-16 w-16 cursor-pointer rounded-full border" src={pictures.pfp} alt="Avatar"/>
              </Link>
              }  
            </div>
          ...
          <div className="flex h-[80%] flex-col p-1 sm:p-5 sm:pt-0">
            ...
            <div className="cursor-pointer" onClick={handleRecentChatClick}>Recent Chat</div>
            <div className="md:hidden cursor-pointer" onClick={handleStartNewClick}>Start New</div>
            </div>
