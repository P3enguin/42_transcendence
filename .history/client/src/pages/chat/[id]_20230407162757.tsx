  ...
  return (
    <>
      ...
      <div className="h-[100%] w-[100%] md:w-[360px] flex-col  md:border-r">
          <div className="flex h-[8%] items-center border-b pl-5 w-[100%]">
            Chat Room
          </div>

          {showRecentChat && <OnlineNow player={data.nickname} avatar={pictures.pfp} />}
          <div className="flex h-[80%] flex-col p-1 sm:p-5 sm:pt-0">
            <div className="flex flex-row justify-between border-t pt-1 h-[10%]">
            ...
            <div className="flex-col h-[100%] overflow-hidden overflow-y-auto space-y-3 mt-2 scrollbar-hide">
