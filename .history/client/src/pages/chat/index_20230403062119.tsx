...
function Chat({ jwt_token, data }: { jwt_token: string; data: any }) {
  ...
  return (
    <>
      ...
      <div className="flex w-[90%] h-[600px] md:h-[800px] mt-10 flex-row rounded-2xl border border-neutral-300 max-w-[1200px] ">
      <div className="h-[100%] w-[100%] md:w-[360px] flex-col  md:border-r">
          ...
          <div className="flex flex-row justify-between border-t pb-1">
            <div>Recent Chat</div>
            <div className="md:hidden">Start New</div>
            </div>
            <div className="flex-col overflow-hidden overflow-y-auto space-y-3 mt-2 ">
