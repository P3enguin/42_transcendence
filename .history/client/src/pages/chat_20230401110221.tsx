...
function Chat({ jwt_token, data }: { jwt_token: string; data: any }) {
  ...
  return (
    <>
      ...
      <div className="m-5 sm:m-20 flex min-h-[600px] max-w-[1500px] min-w-[100px] flex-row rounded-2xl border border-neutral-300  md:h-[70%]">
      <div className="h-[100%] min-w-[360px] flex-col  max-w-[360px] sm:w-[100%] md:border-r">
  ...
  <input type="text" name="nickname" id="nickname"
    className="border-white w-full appearance-none rounded-full border-2 bg-transparent
    py-2.5 px-3 text-xs md:text-sm text-white focus:border-blue-600 focus:outline-none focus:ring-0"
    placeholder="player" required/>
  <button type="submit" className="border-white block appearance-none rounded-full border-2 bg-transparent
    py-2.5 px-3 text-xs md:text-sm text-white focus:border-blue-600 focus:outline-none focus:ring-0 bg-blue-500">
    start
  </button>
</div>
