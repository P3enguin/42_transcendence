...
function Chat({ jwt_token, data }: { jwt_token: string; data: any }) {
      ...
      <div className="m-5 flex min-h-[700px] min-w-[100px] flex-row rounded-2xl border border-neutral-300 sm:m-20 md:h-[80%]">
        ...
        <div className="flex-[2_2_0%] justify-between  ">
          ...
          <div className="flex flex-col w-[100%] h-[95%]">
            ...
            <div className="flex flex-row w-[100%] h-[85%] pl-5">
  ...
  <input
    ...
    className="px-4 py-2 rounded-l-md border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent"
  />
  <button
    type="submit"
    className="px-4 py-2 bg-blue-500 text-white rounded-r-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50"
  >
    Submit
  </button>
</div>
              ...
              <div className="flex flex-row h-[85%] w-[50%] m-auto mb-0 ">
                <div className="flex flex-col h-[10%] w-[90%]">
                  <h2 className="flex text-xl">Direct Message</h2>
                  <input type="text" name="channel" id="password"
                  className=" border-white peer block w-full appearance-none rounded-full border-2 bg-transparent
                  py-2.5 px-3  text-xs md:text-sm max-w-70
                  text-white focus:border-blue-600 focus:outline-none focus:ring-0"
                  placeholder="channel name" required/>
                  <button></button>
                </div>
