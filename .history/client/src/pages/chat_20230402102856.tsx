...
function Chat({ jwt_token, data }: { jwt_token: string; data: any }) {
  ...
  return (
    <>
      ...
      <div className="flex w-[90%] h-[600px] mt-10 flex-row rounded-2xl border border-neutral-300 max-w-[1200px] ">
      <div className="h-[100%] w-[100%] md:min-w-[360px] flex-col  max-w-[500px] md:border-r">
          <div className="flex h-[5%] items-center border-b pl-3">
            Chat Room
          </div>

          <div className="flex h-[15%] w-[100%] flex-col whitespace-nowrap pl-5 ">
            <div className="flex flex-row">
              <div>Online Now</div>
              <div className="ml-40">Start New</div>
            </div>
          ...
          <div className="flex h-[80%] flex-col p-5 pt-0 ">
            <div>Recent Chat</div>

            <div className="flex-col overflow-hidden overflow-y-auto space-y-3 mt-1">

              <div className="flex space-x-2 h-[70px] w-[100%] md:w-[300px] cursor-pointer border 
                  flex-row item-start rounded-2xl text-sm
                   bg-[#8BD9FF] bg-opacity-30 justify-center md:space-x-5">
                <img
                  className="h-12 w-12 rounded-full border self-center" 
                  src={pictures.pfp}
                  alt="Avatar"
                />
        ...
        <div className="hidden md:flex w-[1000px] justify-between flex-col ">
          ...
          <div className="flex flex-col w-[100%] h-[95%] ">
            <div className="md:items-center lg:flex w-[100%] h-[30%] text-3xl">
