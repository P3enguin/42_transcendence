...
function Chat({ jwt_token, data }: { jwt_token: string; data: any }) {
  ...
  return (
    <>
      <div className="m-5 flex min-h-[700px] min-w-[100px] flex-row rounded-2xl  border-neutral-300 sm:m-20 md:h-[80%]">
        ...
        <div className="flex-[2_2_0%] justify-between  ">
          ...
          <div className="flex h-[95%] w-[100%] flex-col">
            ...
            <div className="flex h-[85%] w-[100%] flex-row border pl-5">
