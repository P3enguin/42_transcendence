...
function Chat({ jwt_token, data }: { jwt_token: string; data: any }) {
  ...
  <input
    ...
    name="channel"
    id="password"
    className="border-white peer block w-full appearance-none ounded-full border-2 bg-transparent py-2.5 px-3 text-xs md:text-sm max-w-70 text-white focus:border-blue-600 focus:outline-none focus:ring-0 pr-12"
