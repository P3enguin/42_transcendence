...
function Chat({ jwt_token, data }: { jwt_token: string; data: any }) {
  ...
  return (
    <>
      ...
      <div className="flex w-[90%] h-[800px] mt-10 flex-row rounded-2xl border border-neutral-300 max-w-[1200px] ">
      <div className="h-[100%] w-[100%] md:w-[360px] flex-col  md:border-r">
          ...
          <div className="flex h-[15%] w-[100%] flex-col pl-5 pr-5">
            <div className="flex flex-row justify-between">
              <div >Online Now</div>
              <div className="sm:hidden">Start New</div>
            </div>
            <div className="sm:flex hidden">Start New</div>
          </div>
