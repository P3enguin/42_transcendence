...
function Chat({ jwt_token, data }: { jwt_token: string; data: any }) {
  ...
  <div className="flex flex-col">
    ...
    <button 
      name="create"
      disabled
      className="border-white peer block appearance-none rounded-full border-2 bg-transparent py-2.5 px-3 text-xs md:text-sm w-[100px] text-white focus:border-blue-600 focus:outline-none focus:ring-0 bg-blue-500 mt-2"
    >
      Create 
    </button>
  </div>
