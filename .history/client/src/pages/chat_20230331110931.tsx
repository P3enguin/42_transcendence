...
function Chat({ jwt_token, data }: { jwt_token: string; data: any }) {
  ...
  return (
    <>
      ...
      {/* <div className=" flex min-h-[700px] min-w-[200px] max-w-[1200px] flex-row rounded-2xl border border-neutral-300 sm:m-20 md:h-[80%]"> */}
      <div className="h-screen flex justify-center items-center w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 p-8 bg-white shadow-lg rounded-lg">
        <div className="h-[100%] flex-[1_1_0%] flex-col border-r-[2px]">
          ...
          <div className="flex h-[80%] flex-col pl-5">
            <div>Recent Chat</div>
            <div className="flex-col overflow-hidden overflow-y-auto scrollbar-hide pr-5 ">
