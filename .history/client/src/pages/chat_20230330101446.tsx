        ...
        <div className="flex-[2_2_0%] justify-between  ">
          ...
          <div className="flex flex-col w-[100%] h-[95%]">
            ...
            <div className="flex flex-row w-[100%] h-[60%] pl-5 ">
              ...
              <button name="create"
                 disabled
                className="absolute border-white peer block appearance-none
              ...
              <div className="flex flex-col h-[85%] w-[50%] m-auto">
                <div className="flex flex-col h-[10%] w-[90%]">
                  <h2 className="flex text-xl">Channel:</h2>
                  <input
                    type="text"
                    name="channel"
                    id="channel"
                    className="border-white w-full appearance-none rounded-full border-2 bg-transparent py-2.5 px-3 text-xs md:text-sm text-white focus:border-blue-600 focus:outline-none focus:ring-0"
                ...
                <div className="flex justify-center mt-4">
                  <button
                    name="create"
                    disabled
                    className="border-white peer block appearance-none rounded-full border-2 bg-transparent py-2.5 px-3 text-xs md:text-sm w-[100px] text-white focus:border-blue-600 focus:outline-none focus:ring-0 bg-blue-500"
                  >
                    Create
                  </button>
                </div>
