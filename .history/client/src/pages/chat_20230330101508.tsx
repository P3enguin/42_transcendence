                ...
                <div className="flex justify-center mt-4">
                  <button
                    ...
                    className="border-white peer block 
                      appearance-none rounded-full border-2 bg-transparent 
                        py-2.5 px-3 text-xs md:text-sm w-[100px] text-white focus:border-blue-600 focus:outline-none focus:ring-0 bg-blue-500"
                  >
                    Create
                  </button>
                </div>
