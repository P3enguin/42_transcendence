...
function Chat({ jwt_token, data }: { jwt_token: string; data: any }) {
  ...
  return (
    <>
      ...
      <div className={`h-full flex-${isOtherDivHidden ? 'full' : '[1_1_0%]'} flex-col border-r-[2px] max-w-[360px]`}>
        ...
        <div className="hidden sm:flex flex-[2_2_0%] justify-between flex-col">
